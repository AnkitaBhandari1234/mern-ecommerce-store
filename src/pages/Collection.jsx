  ...
  return (
    <div className='flex border-t gap-10 justify-center pt-10  '>
      ...
      <div className='min-w-60'>
        <p className='my-2 flex items-center cursor-pointer gap-2 text-xl' onClick={()=>{setshowFilter(!showFilter)}}>FILTERS
          <IoIosArrowForward className={`text-gray-500 text-base sm:hidden ${showFilter?'rotate-90 duration-300  ':''}`} />
      ...
      <div className='flex-1'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-6 gap-4'>
        {
          filterProducts.map((val,i)=>{
            return(
              <ProductItem key={i} id={val._id} name={val.name} price={val.price} image={val.image}/>
            )
          })
        }
