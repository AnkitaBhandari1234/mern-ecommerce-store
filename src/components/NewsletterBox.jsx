...
const NewsletterBox = () => {
  ...
  return (
    <div className='text-center'>
        <p className='text-2xl font-medium text-gray-800 mb-3'>Subscribe now & get 20% off</p>
        <p className='text-gray-400 '>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        <form onSubmit={onSubmitHandler} className='w-full sm:w-1/2 flex items-center mx-auto gap-3 my-6 border border-gray-200 pl-3'>
